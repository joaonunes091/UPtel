...
//            {
//                TotalItems = await _context.Funcionarios.Where(p => nomePesquisar == null || p.Nome.Contains(nomePesquisar) || p.Contribuinte.Contains(nomePesquisar)).CountAsync(),
//                PaginaAtual = pagina
//            };

//            List<Users> funcionarios = await _context.Funcionarios.Where(p => nomePesquisar == null || p.Nome.Contains(nomePesquisar) || p.Contribuinte.Contains(nomePesquisar))
//                .Include(f => f.Cargo)
...
//        public async Task<IActionResult> Create(RegistoUserViewModel infofuncionario, IFormFile ficheiroFoto )
//        {
//            Users funcionarios = new Users
//            {
//                Nome = infofuncionario.Nome,
//                Email = infofuncionario.Email,
//                Data = infofuncionario.Data,
...
//                TipoFuncionarioId = infofuncionario.TipoFuncionarioId,
//            };
...
//            if (utilizador != null)
//            {
//                ViewData["CargoId"] = new SelectList(_context.Cargos, "CargoId", "NomeCargo", funcionarios.UserId);
...
//            if (infofuncionario.Data > DateTime.Today.AddYears(-18))
//            {
//                ModelState.AddModelError("DataNascimento", "Para se registar tem que ter mais de 18 anos");
//                ViewData["TipoClienteId"] = new SelectList(_context.Cargos, "CargoId", "Designacao", funcionarios.UserId);
//                return View(infofuncionario);
//            }
...
//                ViewData["CargoId"] = new SelectList(_context.Cargos, "CargoId", "Designacao", funcionarios.UserId);
//                return View(infofuncionario);
//            }
//            else
//            {
...
//            if (infofuncionario.Nome == null || infofuncionario.Contribuinte == null || infofuncionario.Morada == null ||
